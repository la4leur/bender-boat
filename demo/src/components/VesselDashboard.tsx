        ...
        <div className="card-body p-4">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-base-content/60 mt-1">{vessel.class} • Flag: {vessel.flag} • IMO: {vessel.imo}</p>
              <p className="text-base-content/60 text-xs">Official No: {vessel.officialNumber}</p>
            </div>
