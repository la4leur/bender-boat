      ...
      <div className={`max-w-4xl mx-auto text-center relative fade-up ${isVisible ? 'visible' : ''}`}>
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-12">
          <div className="px-8 py-6 rounded-2xl bg-dark-800/80 border border-sea-500/30 text-center min-w-[220px]">
            ...
            <div className="text-3xl font-black text-sea-400">$1,880<span className="text-lg font-normal text-dark-400">/mo</span></div>
            <div className="text-dark-500 text-xs mt-1">+ $20/PNR · ~$26,600/year</div>
          </div>
          <div className="px-8 py-6 rounded-2xl bg-dark-800/80 border border-gold-500/30 text-center min-w-[220px]">
            ...
            <div className="text-3xl font-black text-gold-400">$3,000<span className="text-lg font-normal text-dark-400">/mo</span></div>
            <div className="text-dark-500 text-xs mt-1">+ $20/PNR · ~$40,000/year</div>
          </div>
        </div>

        <p className="text-sm text-dark-500 mb-12 max-w-xl mx-auto">
          vs <span className="text-red-400">$45,200/year</span> for HELM + D-A/Atriis combined — 41% savings on day one with full data ownership.
          <br />
          <span className="text-emerald-400">5-year savings: ~$93,000</span> with infinitely more capability.
        </p>
