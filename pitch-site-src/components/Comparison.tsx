      ...
      <div className="max-w-5xl mx-auto">
        <div className={`fade-up ${isVisible ? 'visible' : ''} mb-16`}>
          ...
          <p className="text-xl text-dark-300 max-w-3xl">
            HELM quoted ~$20,000/year for vessel ops. Direct Accommodations runs ~$25,200/year for travel ($1,600/mo base + $10/PNR) — stripped down, no reporting. Combined: $45,200/year for two disconnected tools. Here's what $1,880/mo + $20/PNR looks like.
          </p>
        </div>
          ...
          <div className="overflow-hidden rounded-2xl border border-dark-700 bg-dark-800/40">
            ...
            <div className="grid grid-cols-12 gap-4 p-5 bg-dark-800 border-b border-dark-700">
              ...
              <div className="col-span-4 text-sm font-semibold text-sea-400 uppercase tracking-wider text-center">
                Bender Boat <span className="text-emerald-400/60">~$26.6k/yr</span>
              </div>
            </div>
        ...
        <div className={`fade-up fade-up-delay-2 ${isVisible ? 'visible' : ''} mt-8 p-6 rounded-2xl bg-gradient-to-r from-sea-500/10 to-gold-500/10 border border-sea-500/20`}>
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex gap-12">
              ...
              <div className="text-center">
                <div className="text-3xl font-black text-emerald-400">$133k</div>
                <div className="text-sm text-dark-500">Bender Boat (5 years) — save $93k</div>
              </div>
            </div>
          </div>
          <div className="mt-4 text-dark-400 text-sm">
            41% savings on day one. $93,000 saved over 5 years. One unified system instead of two. Full data ownership. And capabilities neither vendor offers at any price.
          </div>
        </div>
      </div>
    </section>
