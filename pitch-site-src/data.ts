...
export const comparison: ComparisonRow[] = [
  ...
  { feature: 'Emergency Travel (Lifeline)', helm: 'Call Sam at 4 AM', helmStatus: 'no', bender: 'AI auto-rebook with 3-tier authorization — nobody gets woken up', benderStatus: 'exceeds' },
  { feature: 'AI Guardrails', helm: 'Not available', helmStatus: 'no', bender: 'Configurable auto-authorize, morning digest, smart escalation', benderStatus: 'exceeds' },
  ...
  { feature: 'Annual Cost (3 vessels)', helm: '~$45,200/year (combined)', helmStatus: 'partial', bender: '~$26,600/year (Phase 1: $1,880/mo + $20/PNR)', benderStatus: 'exceeds' },
  { feature: 'White-Label Ready', helm: 'Not available', helmStatus: 'no', bender: 'Resell to your crew management clients (e.g., Lindblad)', benderStatus: 'exceeds' },
...
export const buildPhases: BuildPhase[] = [
  ...
  },
  {
    ...
    highlight: 'SANSU goes live — $1,880/mo + $20/PNR revenue starts',
  },
  {
    phase: 5,
    title: 'Advanced Logistics (V1.5)',
    weeks: 'Weeks 11–18',
    deliverables: [
      'Lifeline — AI-powered emergency travel rebooking',
      'AI Guardrails — configurable 3-tier auto-authorize',
      'C Teleport integration — automated flight booking',
      'Change Portal — expense tracking & refund attribution',
      'Travel packets, visa tracking, ground logistics',
    ],
    highlight: 'D-A eliminated. Nobody gets woken at 4 AM ever again.',
  },
  {
    phase: 6,
    title: 'Engineering & Scale (V2)',
    weeks: 'Weeks 19–28',
    deliverables: [
      'Equipment registry & planned maintenance system',
      'Work order workflows & running-hour triggers',
      'Parts inventory tracking',
      'White-label platform for Standing Tide resale',
      'Gusto payroll sync + Lindblad onboarding',
    ],
    highlight: 'White-label unlocks Lindblad (~$146k/yr revenue potential)',
  },
];
