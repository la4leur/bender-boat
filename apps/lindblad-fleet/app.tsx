...
import { Ship, ArrowLeftRight, AlertTriangle, Users, FileText, UserPlus } from 'lucide-react';
...
type TabId = 'fleet' | 'changes' | 'billets' | 'roster' | 'report' | 'hiring';

const tabs: { id: TabId; label: string; icon: React.ReactNode; highlight?: boolean }[] = [
  { id: 'fleet', label: 'Fleet', icon: <Ship size={18} /> },
  { id: 'hiring', label: 'Hiring & Onboarding', icon: <UserPlus size={18} />, highlight: true },
  ...
  return (
    <div className="min-h-screen bg-base-200">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-base-content/60">Fleet Crewing Dashboard — 4 Vessels • Hiring → Onboarding → Crew Change Pipeline</p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto p-4">
        ...
        {activeTab === 'hiring' && <HiringOnboarding />}
